...
\begin{document}
\mailfields{noSurat,namaPemohon,npmPemohon,prodi,matkul,judulTopik,instansi,alamat,tujuanKunjungan,namaAnggota,npmAnggota,tanggal}
...
\mailentry{5,MARCELL TRIXIE ALEXANDER,2014730003,Teknik Informatika,MATKUL,TOPIK,ORGANISASI,ALAMAT,PERLU,A,1,19 May 2017}
\end{document}
