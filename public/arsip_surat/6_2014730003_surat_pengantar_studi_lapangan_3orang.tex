...
\begin{document}
\mailfields{noSurat,namaPemohon,npmPemohon,prodi,matkul,judulTopik,instansi,alamat,tujuanKunjungan,namaAnggota1,npmAnggota1,namaAnggota2,npmAnggota2,tanggal}
...
\mailentry{6,MARCELL TRIXIE ALEXANDER,2014730003,Teknik Informatika,MATKUL,TOPIK,ORGANISASI,ALAMAT,PERLU,A,1,B,2,19 May 2017}
\end{document}