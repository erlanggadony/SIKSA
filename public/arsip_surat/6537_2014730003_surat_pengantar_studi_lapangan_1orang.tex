...
\begin{document}
\mailfields{noSurat,nama,npm,prodi,matkul,judulTopik,instansi,alamat,tujuanKunjungan,kepada,kota,tanggal}
...
\mailentry{6537,MARCELL TRIXIE ALEXANDER,2014730003,3,Modsim,Queue,GraPARI,Dago,survey,,}
\end{document}
