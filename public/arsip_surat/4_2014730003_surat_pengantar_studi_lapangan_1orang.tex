...
\begin{document}
\mailfields{noSurat,nama,npm,prodi,matkul,judulTopik,instansi,alamat,tujuanKunjungan,tanggal}
...
\mailentry{4,MARCELL TRIXIE ALEXANDER,2014730003,Teknik Informatika,MATKUL,TOPIK,ORGANISASI,ALAMAT,PERLU,19 May 2017}
\end{document}
